...
export function computeDropZone(userElements) {
  ...
  // Anchor: a 1x1 bbox at the top-right of user's bbox. placeNear will
  // push AI elements further right by GAP.
  return { x: Math.min(maxX, MAX_X - 400), y: minY, width: 1, height: 1 };
}
