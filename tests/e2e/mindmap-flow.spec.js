...
test('mindmap flow: center node renders at viewport center', async ({ page }) => {
  const ctx = startSession('mindmap', 'mindmap-e2e');
  try {
    ...
    expect(texts.some(t => t.includes('Central Idea'))).toBeTruthy();
